...
long_description = 'The aim of this package is to easily obtain DeepET embeddings for protein sequences.'

setup(
	name='DeepET',    # This is the name of your PyPI-package.
	description='Obtain DeepET embeddings for protein sequences.',       #package description
    ...
    install_requires=['tensorflow==1.15.0', 'numpy==1.18.1', 'pandas==1.0.1', 'biopython==1.76', 'jupyter', 'keras==2.3.1'],
	license='GPLv3+',
	classifiers=[
